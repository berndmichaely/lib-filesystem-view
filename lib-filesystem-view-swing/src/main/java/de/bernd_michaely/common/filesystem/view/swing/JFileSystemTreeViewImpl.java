	...
	private class PathViewTreeCellRenderer extends DefaultTreeCellRenderer
	{
			...
			boolean sel, boolean expanded, boolean leaf, int row, boolean hasFocus)
		{
			...
			if (value instanceof JNodeView.NodeViewTreeNode treeNode)
			{
				...
				final var symbolicLinkTarget = pathView.getSymbolicLinkTarget();
				final boolean isSymbolicLink = symbolicLinkTarget != null;
				...
				setToolTipText(isSymbolicLink ? pathView + " → " + symbolicLinkTarget : null);
			}
